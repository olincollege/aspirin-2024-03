...
extern "C" {
    ...
    fn curl_easy_perform(easy_handle: *const CURL) -> CURLcode;
    fn curl_easy_cleanup(handle: *const CURL) -> std::ffi::c_void;
    fn curl_easy_init() -> *const CURL;
}
...
pub fn run_curl() {
    ...
    unsafe {
        ...
        curl_easy_setopt(
            ...
            std::ffi::CString::new("https://www.google.com")
                .unwrap()
                .as_c_str()
                .as_ptr() as _,
        );
